...
<?php echo $this->Form->create('TipoDocumento'); ?>
	<fieldset>
		<legend><?php echo __('Edit Tipo Documento'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('TipoDocumento.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('TipoDocumento.id')))); ?></li>
