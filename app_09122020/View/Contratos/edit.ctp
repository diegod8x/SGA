<div ng-controller="contratosEdit" ng-init="obtDatos(<?php if(isset($this->request->pass[0])){ echo $this->request->pass[0]; }?>)" >
					...
					<div class="col-md-12">
						<table class="table table-bordered table-hover table-condensed">
							<tr style="height:45px !important">
								...
								<td class="col-md-2" ng-model="formulario.TipoContrato.nombre">{{formulario.TipoContrato.nombre}}</td>
								<th class="col-md-2 text-right" style="padding-top:10px;border-right:none">Estado</th>
								<td class="col-md-2">
									<div class="col-md-12">
										<select class="form-control" ng-model="formulario.Contrato.estado" on-select="open('cerrar')">
							...
							<tr style="height:45px !important">
								<th class="col-md-2 text-right">Fecha Inicio</th>
