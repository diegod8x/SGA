	...
	<div ng-show="formContratos">
		<div class="container-fluid">
			...
			<div class="text-center col-md-12">
				...
				<button class="volver btn btn-primary btn-lg" confirmed-click="contratoCliente()" ng-confirm-click="Enviaras un contrato por correo al cliente actual. ¿ Deseas continuar ?" ng-disabled="desabilita"><i class="fa fa-send"></i> Enviar a Cliente</button>
			</div>
		</div> 
