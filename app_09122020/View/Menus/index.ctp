		...
		<tr>
			...
			<td style="width: 8%">
				<div>
					...
					<?php echo $this->Form->postLink($this->Html->tag('i','',array('class'=>'fa fa-editz')),array('action' => 'delete', $menu['Menu']['id']),array('class' => 'btn-sm btn btn-danger tool'), __('Desea eliminar el menu %s?', $menu['Menu']['nombre'])); ?>	
				</div>
			</td>
		</tr>
		<?php endForeach; ?>
