			...
			<div class="row">
				...
				<form role="form" class="form-horizontal" name="actividadesEdit" novalidate>
					...
					<div class="form-group" ng-class="{ 'has-error': !actividadesEdit.Comentarios.$valid }">
						...
						<div class="col-md-6">
							<textarea type="text" class="form-control sube col-md-6" name="Comentarios"
						 ng-model="formulario.Actividade.comentarios" required></textarea>
						</div>
					</div>
					...
					<div class="form-group" ng-class="{ 'has-error': !actividadesEdit.TipoActividade.$valid }">
						...
						<div class="col-md-6">
							<ui-select ng-model="formulario.Actividade.tipo_actividade_id" name="TipoActividade" theme="select2"
						        ng-disabled="true"
					...
					<div class="form-group" ng-class="{ 'has-error': !actividadesEdit.Observaciones.$valid }">
						...
						<div class="col-md-6">
						 ...
						 ng-model="formulario.Actividade.observaciones" ng-disabled="true" ></textarea>
						</div>
					</div>
					...
					<div class="form-group" ng-class="{ 'has-error': !actividadesEdit.fechaActividad.$valid }">
						...
						<div class="input col-md-6">
							<input class="form-control datepicker sube" readonly="readonly" id="fechaActividad" name="fechaActividad" ng-model="formulario.Actividade.fecha_ingreso" placeholder="Fecha" style="padding-left: 12px;" ng-disabled="true" required>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="input text col-md-6">
							<input class="form-control sube" type="text"  id="horaAcordada" name="horaAcordada" placeholder="Hora" ng-model="formulario.Actividade.hora_ingreso" readonly ng-disabled="true">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class=" col-md-6">
							<input type="text" name="Direccion" class="form-control" ng-model="formulario.Actividade.direccion" ng-disabled="true" style="margin-top:0px !important">
						</div>
					</div>
					...
					<div class="form-group" ng-class="{ 'has-error': !actividadesEdit.Comunas.$valid }">
						...
						<div class="col-md-6">
							<ui-select ng-model="formulario.Actividade.comuna_id" name="Comunas" ng-required="!!formulario.Actividade.direccion" theme="select2"
						        ng-disabled="true"
						        reset-search-input="true"		
						        style="width: 100%;">
					...
					<div class="form-group">
						...
						<div class="input col-md-6">
							<input type="text" name="Direccion" class="sube form-control" ng-model="formulario.Actividade.gps" ng-disabled="true">
						</div>
					</div>
