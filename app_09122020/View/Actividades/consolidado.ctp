<div ng-controller="actividadesConsolidado" ng-cloak>
	<p ng-bind-html="cargador" ng-show="loader"></p>
	<div ng-show="tablaDetalle">
		<div class="row">
			<div  class="col-md-12">
				<div class="col-md-12">
					<h3>Consolidado Actividades</h3>
				</div>
				<form class="form-inline" name="actividades" novalidate>					
					<div class="col-md-12" style="margin-bottom: 20px;">
						<div class="form-group">
							<div class="input text">	
								<input class="form-control datepicker readonly-pointer-background" readonly="readonly" id="fechaInicio" name="fechaInicio" ng-model="actividades.fecha_inicio" placeholder="Fecha inicio" style="padding-left: 12px;" required>
							</div>
						</div>
						<div class="form-group">
							<div class="input text">	
								<input class="form-control datepicker readonly-pointer-background" readonly="readonly" id="fechaTermino" name="fechaTermino" ng-model="actividades.fecha_termino" placeholder="Fecha término" style="padding-left: 12px;" required>
							</div>
						</div>
						<div class="form-group">							
