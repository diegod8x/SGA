...
<?php echo $this->Form->create('Recaudacione'); ?>
	<fieldset>
		<legend><?php echo __('Edit Recaudacione'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Recaudacione.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Recaudacione.id')))); ?></li>
