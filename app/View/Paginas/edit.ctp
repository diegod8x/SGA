<div class="col-md-10 ">
	<?php echo $this->Form->create('Pagina'); ?>
		...
		<!--fieldset>
			<h4 class="col-md-offset-1"> <?php echo __('Editar Pagina'); ?></h4>
			...
			<div class="required-field-block"  class="col-xs-4" >
				<?php echo $this->Form->input('accion', array("class"=>"form-control", "placeholder"=>"Ingrese Accion", "label"=>false, "required"=>"required"));?>
			</div>
			<div class="required-field-block"  class="col-xs-4" >
				<?php echo $this->Form->input('accion_fantasia', array("class"=>"form-control", "placeholder"=>"Ingrese Accion Fantasia", "label"=>false, "required"=>"required"));?>
			</div>
			...
			<br/>
			<div class="required-field-block"  class="col-xs-4" >
				<?php echo $this->Form->input('menu_id', array("type"=>"select","class"=>"form-control", "placeholder"=>"", "label"=>"Menu", 'options' => $menus));?>
			</div>			
		</fieldset-->
		<br/><br/>
		<div class="text-right col-md-10">
			<button class="btn btn-primary btn-lg"><i class="fa fa-pencil-square-o"></i> Editar</button> 
