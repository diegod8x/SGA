			...
			<div class="col-md-10">
				...
				<ul class="nav nav-tabs" id="myTab" role="tablist">
					<li class="nav-item">
						...
						<a class="nav-link" id="contratos-tab" data-toggle="tab" href="#contratos" role="tab" aria-controls="contratos" aria-selected="true">
					...
					<li class="nav-item">
						<a class="nav-link active" id="pagos-tab" data-toggle="tab" href="#pagos" role="tab" aria-controls="pagos" aria-selected="false">
				...
				<div class="tab-content" id="myTabContent">
					...
					<div class="tab-pane fade active in" id="pagos" role="tabpanel" aria-labelledby="pagos-tab">
						<div ui-i18n="{{lang}}">
