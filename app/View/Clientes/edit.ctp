<div ng-controller="clientesEdit" ng-init="obtDatos(<?php if (isset($this->request->pass[0])) {
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="row">
				<form class="form-horizontal" name="clientesEdit" novalidate>
					...
					<div class="form-group" ng-class="{ 'has-error': !clientesEdit.Observaciones.$valid }">
...
-->
			...
			<div class="row" style="margin-top: 20px">
				...
				<div class="col-md-6">
					<a href="<?php echo $this->Html->url(array("controller" => "direcciones", "action" => "index"/*, $this->request->pass[0]*/)) ?>" class="btn btn-success btn-lg btn-block"><i class="fa fa-pencil"></i> Editar Direcciones</a>
				</div>
			</div>
