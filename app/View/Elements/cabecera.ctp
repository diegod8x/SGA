<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<a class="navbar-brand" href="#" style="cursor:initial;"><?php echo $this->Html->image('logo.jpg', array('alt' => 'www.camas.cl', 'width' => '41')); ?></a>
	</div>
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<?php  
		

		foreach($this->Session->read("Menus") as $key => $menuPrincipal) : ?>
						...
						<?php  foreach($menuPrincipal as $key => $datosMenu) :?>
							<?php  if(count($datosMenu) == 1) : ?>
								<?php  foreach($datosMenu as $link) : ?>
									<?php  if($link["controlador"] == "subscribers") : ?>
		...
		<ul class="nav navbar-nav navbar-right">
			<li><a href="<?php echo $this->Html->url(array('controller' => 'users', 'action' => 'perfil'));?>"><i class="fa fa-user"></i> <?php echo $this->Session->Read("Users.nombre");?></a></li>
