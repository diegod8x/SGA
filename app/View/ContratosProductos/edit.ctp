...
<?php echo $this->Form->create('ContratosProducto'); ?>
	<fieldset>
		<legend><?php echo __('Edit Contratos Producto'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ContratosProducto.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ContratosProducto.id')))); ?></li>
