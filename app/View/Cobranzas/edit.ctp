...
<?php echo $this->Form->create('Cobranza'); ?>
	<fieldset>
		<legend><?php echo __('Edit Cobranza'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Cobranza.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Cobranza.id')))); ?></li>
