	...
	<div ng-show="formContratos">
		<div class="container-fluid">
			<div class="row">
				...
				<form role="form" class="form-horizontal" name="contratosAdd" novalidate>				
					...
					<div class="form-group" ng-class="{ 'has-error': !contratosAdd.Clientes.$valid }">
						...
						<div class="col-md-7">
							<ui-select ng-model="formulario.Contrato.cliente_id" name="Clientes" required>
								<ui-select-match placeholder="Seleccione un tipo de cliente">
									{{$select.selected.nombre}}
								</ui-select-match>
			...
			<div class="text-center col-md-12">
				...
				<a ng-show="!!formulario.Contrato.id" href="<?php echo $this->Html->url(array('controller'=>'actividades', 'action'=>'add')).DS?>{{formulario.Contrato.id}}<?php echo DS;?>{{formulario.Contrato.cliente_id}}<?php echo DS;?>#<?php echo DS;?>{{productosNew}}" 
