...
<body>
	...
	<p>Dirección: <?php echo $datos["Cliente"]["direccion"]; ?> <br />
		...
		Adjunto la información con desglose de los servicios prestados.
	</p>
		...
		<table width="900" align="center" style="color:#333333;border-width: 1px; border-color: #3A3A3A;border-collapse: collapse;">
			...
			<?php foreach ($datos["Producto"] as $producto) : ?>
				<tr>
					...
					<td align="right" style="border-width: 1px;padding: 8px;border-style: solid;border-color: #3A3A3A;background-color: #ffffff;"><?php echo ($datos["TipoContrato"]["id"] == 1) ? number_format($producto["ContratosProducto"]["precio_arriendo"], 0, '', '.') : number_format($producto["ContratosProducto"]["precio_venta"], 0, '', '.'); ?></td>
				</tr>
			<?php endforeach; ?>
			<tr>
				<th colspan="2" align="right" style="padding: 8px;"> <?php echo ($datos["TipoContrato"]["id"] == 1) ? "Mensualidad" : "Subtotal" ?> </th>
			...
			<tr>
				<th colspan="2" align="right" style="padding: 8px;">Garantía </th>
				<th align="right" style="border-width: 1px;padding: 8px;border-style: solid;border-color: #3A3A3A;background-color: #ffffff;">$ <?php echo number_format($datos["Contrato"]["garantia"], 0, '', '.'); ?></th>
			</tr>
			<tr>
