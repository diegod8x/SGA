...
<body>
	...
	<p>Gracias por preferir nuestro producto y servicio.<br>
	...
	<p>Agradeceré informar trasferencia o depósito, con la dirección donde se presta el servicio a <a href="mailto:ventas@conec.cl" target="_top">ventas@conec.cl</a> </p>
	<br>
	<p>&nbsp;</p>	
		...
		if ($datos["TipoContrato"]["id"]==1){ ?>
			<table align="center" width="600" style="border-width: 0px; border-collapse: collapse;">
				<tr><td align="center">
					...
					Informar depósito o transferencia con un correo electrónico a:  info@camas.cl<br>
					El no pago de la mensualidad, acusa término al contrato de arriendo.<br>
					El período de arriendo mínimo es un mes completo a partir del día de entrega<br>
